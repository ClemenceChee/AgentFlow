...
export function usePrefetch() {
  ...
  const prefetch = useCallback(
    async <T>(
      ...
      const { delay = 300, cache = true, maxCacheSize = 50, priority = 'normal' } = options;
  ...
  const prefetchTeamData = useCallback(
    async (teamId: string, options?: PrefetchOptions) => {
  ...
  const prefetchTeamPerformance = useCallback(
    async (teamId: string, options?: PrefetchOptions) => {
  ...
  const prefetchTeamActivity = useCallback(
    async (teamId: string, options?: PrefetchOptions) => {
  ...
  const prefetchOperatorData = useCallback(
    async (operatorId: string, options?: PrefetchOptions) => {
  ...
  const prefetchOperatorActivity = useCallback(
    async (operatorId: string, options?: PrefetchOptions) => {
  ...
  const prefetchSessionCorrelations = useCallback(
    async (sessionId: string, options?: PrefetchOptions) => {
...
export function useHoverPrefetch() {
  ...
  const createHoverHandlers = useCallback(
    (id: string, type: 'team' | 'operator', options?: PrefetchOptions) => {
