...
export const ResourceAllocationInsights: React.FC<Props> = ({
    ...
    () => [
      {
        ...
        timeOfDay: [
          10, 15, 20, 25, 30, 35, 45, 60, 85, 95, 90, 85, 80, 85, 90, 95, 85, 70, 50, 35, 25, 20,
          15, 10,
        ],
      ...
      },
      {
        ...
        timeOfDay: [
          95, 85, 70, 50, 30, 20, 15, 10, 10, 15, 20, 25, 30, 35, 40, 45, 50, 60, 70, 80, 85, 90,
          95, 95,
        ],
    ...
    () => [
      {
        ...
        description:
          'Frontend team is underutilizing allocated resources while backend shows consistent demand',
        rationale:
          'Frontend utilization at 72% vs backend at 68%, but frontend shows 18.5% waste vs backend 24.2%',
        impact: {
      ...
      },
      {
        ...
        description:
          'Cache utilization reaches 95% during business hours, causing performance degradation',
        rationale:
          'Hit rate drops to 76% during peaks vs 89% average, indicating insufficient capacity',
        impact: {
  ...
  const renderOverview = () => {
    ...
    const avgUtilization =
      mockResourcePools.reduce((sum, pool) => sum + pool.utilization, 0) / mockResourcePools.length;
    const totalRecommendations = mockRecommendations.length;
    const potentialSavings = mockRecommendations.reduce(
      (sum, rec) => sum + Math.abs(rec.impact.costChange),
      0,
    );
            ...
            {mockResourcePools.map((pool) => (
              ...
              >
                <div className="org-pool-header">
                  <h5>{pool.name}</h5>
                  <div className={`org-pool-type org-type-${pool.type}`}>{pool.type}</div>
                </div>
                ...
                <div className="org-pool-metrics">
                  <div className="org-metric-item">
                    ...
                    <span>
                      {pool.type === 'storage'
                        ? formatBytes(pool.totalCapacity * 1024 * 1024)
                        : pool.totalCapacity}
                    </span>
                  </div>
                  <div className="org-metric-item">
                    ...
                    <div className="org-team-allocations">
                      ...
                      {pool.teams.map((team) => (
                        <div key={team.teamId} className="org-team-allocation">
                          ...
                          <span className="org-utilization-value">{team.utilization}%</span>
                        </div>
                      ))}
                    </div>
  ...
  const renderTeams = () => (
    <div className="org-team-resource-profiles">
      <div className="org-section-header">
        ...
        <div className="org-profile-summary">{mockTeamProfiles.length} teams analyzed</div>
      </div>
      ...
      <div className="org-team-profiles-grid">
        {mockTeamProfiles.map((profile) => (
          <div
            ...
            onClick={() =>
              setSelectedTeamProfile(selectedTeamProfile === profile.teamId ? null : profile.teamId)
            }
          >
            ...
            <div className="org-optimization-opportunities">
              ...
              <div className="org-optimization-metrics">
                <div className="org-optimization-item">
                  ...
                  <span className="org-waste">
                    {profile.optimization.wastedCapacity.toFixed(1)}%
                  </span>
                </div>
                <div className="org-optimization-item">
                  <span>Potential Savings:</span>
                  <span className="org-savings">
                    ${profile.optimization.rightsizingOpportunity}/mo
                  </span>
                </div>
              </div>
                ...
                <div className="org-sharing-potential">
                  ...
                  <div className="org-sharing-teams">
                    {profile.optimization.sharingPotential.map((teamId) => (
                      <span key={teamId} className="org-sharing-team">
                        {teamId}
                      </span>
                    ))}
                  </div>
              ...
              <div className="org-profile-details">
                <div className="org-workload-characteristics">
                  ...
                  <div className="org-characteristics-grid">
                    ...
                    <div className="org-characteristic">
                      ...
                      <span>
                        {(profile.workloadCharacteristics.predictability * 100).toFixed(0)}%
                      </span>
                    </div>
                    <div className="org-characteristic">
                ...
                <div className="org-cost-efficiency">
                  ...
                  <div className="org-efficiency-metric">
                    ...
                    <span className="org-efficiency-score">
                      ${profile.costEfficiency.toFixed(2)}
                    </span>
                  </div>
                </div>
              </div>
      ...
      <div className="org-recommendations-list">
        {mockRecommendations.map((recommendation) => (
          <div key={recommendation.id} className="org-recommendation-card">
            ...
            <div className="org-recommendation-description">{recommendation.description}</div>
            ...
            <div className="org-impact-summary">
              ...
              <div className="org-impact-grid">
                <div className="org-impact-item">
                  ...
                  <span
                    className={
                      recommendation.impact.performanceChange > 0 ? 'org-positive' : 'org-negative'
                    }
                  >
                ...
                <div className="org-impact-item">
                  ...
                  <span
                    className={
                      recommendation.impact.costChange < 0 ? 'org-positive' : 'org-negative'
                    }
                  >
                ...
                <div className="org-impact-item">
                  ...
                  <span
                    className={
                      recommendation.impact.utilizationChange > 0 ? 'org-positive' : 'org-negative'
                    }
                  >
            ...
            <div className="org-timeline-info">
              ...
              <div className="org-timeline-details">
                ...
                <div className="org-timeline-item">
                  <span>Can Start:</span>
                  <span>
                    {recommendation.timeline.immediate ? 'Immediately' : 'Requires Planning'}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="org-recommendation-actions">
              ...
              <button className="org-button org-button-secondary">Schedule Implementation</button>
              <button className="org-button org-button-tertiary">Request Analysis</button>
            </div>
          </div>
        ))}
      </div>
          ...
          return (
            <div key={forecast.forecastId} className="org-forecast-card">
              <div className="org-forecast-header">
                ...
                <div className="org-forecast-horizon">{forecast.forecastHorizon} forecast</div>
              </div>
                    ...
                    points={
                      forecast.predictions
                        ...
                        .map((pred, i) => {
                          ...
                          const _y2 = 150 - pred.lowerBound * 1.5;
                          return `${x},${y1}`;
                        })
                        .join(' ') +
                      ' ' +
                  ...
                  <div className="org-seasonality-result">
                    {forecast.seasonality.detected ? (
                      <span className="org-detected">
                        ✓ {forecast.seasonality.pattern} (strength:{' '}
                        {(forecast.seasonality.strength * 100).toFixed(0)}%)
                      </span>
                    ) : (
    ...
    <div className={`org-resource-allocation-insights ${className}`}>
      ...
      {effectiveTeamId && (
        <div className="org-context-info">
          <div className="org-context-badge">Resource insights for: {effectiveTeamId}</div>
        </div>
      )}
    </div>
  );
