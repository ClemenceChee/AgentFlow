...
export function useRenderPerformance(componentName: string, props?: any) {
  ...
  useEffect(() => {
    ...
    if (process.env.NODE_ENV === 'development') {
      console.debug(`[${componentName}] Render #${renderCount.current}, ${timeSinceLastRender}ms since last render`, props);
    }
  });
...
export const OptimizedListItem = memo(<T extends any>({
  item,
  index,
  isSelected = false,
  isVisible = true,
 ...
 */
export function useComponentSize(): [React.RefObject<HTMLDivElement>, { width: number; height: number }] {
