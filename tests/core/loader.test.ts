...
describe('loadGraph', () => {
  ...
  it('handles nodes as a plain object (runner output format)', () => {
    const json = {
      ...
      rootNodeId: 'n1',
      nodes: {
        n1: { id: 'n1', type: 'agent', name: 'root', startTime: 100, endTime: 200, status: 'completed', parentId: null, children: ['n2'], metadata: {}, state: {} },
        n2: { id: 'n2', type: 'tool', name: 'fetch', startTime: 110, endTime: 190, status: 'completed', parentId: 'n1', children: [], metadata: {}, state: {} },
      },
  ...
  it('handles nodes as an array of [id, node] pairs', () => {
    const json = {
      ...
      rootNodeId: 'n1',
      nodes: [
        ['n1', { id: 'n1', type: 'agent', name: 'root', startTime: 100, endTime: 200, status: 'completed', parentId: null, children: [], metadata: {}, state: {} }],
      ],
      edges: [],
      startTime: 100,
      endTime: 200,
